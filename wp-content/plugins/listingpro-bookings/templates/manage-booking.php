                    ...
                    <div class="lp-coupon-box-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="user-booking-settings">
                                ...
                                <span><?php echo lp_get_listing_dropdown('setting-listing-dropdown', 'select2-ajax', 'listingsettings', 'bookings', null); ?></span>
    ...
    <div class="custom-col-width col-md-9 booking-left-section">
        ...
        <div class="bookings">
            ...
            <div class="panel with-nav-tabs panel-default lp-dashboard-tabs col-md-12 lp-left-panel-height lp-left-panel-height-outer padding-bottom0">
                                        ...
                                        <li class="cell">
                                            <div class="dropdown">
                                                <button class="btn dropdown-toggle" type="button"
                                                        data-toggle="dropdown"> <?php echo listingpro_booking_status_label($booking_status); ?>
                            ...
                            foreach ($lp_bookings_arr as $k => $v) {
                                ...
                                if($booking_status == 'CANCELED') {
                                    ...
                                    <ul class="booking-action-content">
                                        ...
                                        <li class="cell">
                                            <div class="dropdown">
                                                <button class="btn dropdown-toggle" type="button" data-toggle="dropdown"> <?php echo listingpro_booking_status_label($booking_status); ?>
                                                    &nbsp;&nbsp;<i class="fa fa-angle-down"></i></button>
                                                <ul class="dropdown-menu">
                                                    <li><a data-status="PENDING" data-id="<?php echo $booking_id; ?>" href="#"><?php echo esc_html__('PENDING','listingpro-bookings'); ?></a>
                                                    </li>
                ...
                <input class="pending_listing_Arr" type="hidden" value="<?php echo $pending_listing_Arr .' '. esc_html__('Appointments are pending for approval. Pending appointments will only show in calendar upon approval.','listingpro-bookings'); ?>">
            </div>
        </div>
    </div>
